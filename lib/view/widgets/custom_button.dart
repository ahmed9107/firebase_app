  ...
  Widget build(BuildContext context) {
    ButtonStyle buttonStyle =  TextButton.styleFrom(
      backgroundColor: onPressed == null
          ...
          : transparent ? Colors.transparent : AppColor.primaryColor,
      minimumSize: Size(
            ...
            children: [
              icon != null
                ? Padding(
                    ...
                    child: Icon(icon, color : transparent ? AppColor.primaryColor : Theme.of(context).cardColor),
                )
                : const SizedBox(),
              Text(text,
                style: TextStyle(
                  fontSize: fontSize != null ? fontSize! : Dimensions.font16,
                  color : transparent ? AppColor.primaryColor : Theme.of(context).cardColor
              ))
            ]
          ),
        )
